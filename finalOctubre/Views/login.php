...
?>
        <div class="form-wrapper shadow-sm">
            ...
            <form action="<?php echo FRONT_ROOT?>Auth/Login" method = 'post' class="form mt-4">
                <div class="form-group mb-4">
                    <label for="" class="mb-2">Email</label>
                    <input type="email" name='email' class="form-control shadow-sm" requires/>
                </div>
                <div class="form-group mb-4">
                    <label for="" class="mb-2">Contrasenia</label>
            ...
            <div>
                <a href="<?php echo FRONT_ROOT?>Auth/ShowAddUser" class="text-primary">¿Aún no tenés cuenta?</a>
            </div>
        </div>
    </main>
