                ...
                <div class="col-md-8">
                    <div class="card mb-4">
                        <div class="card-body">
                          ...
                          <p class="card-text">Detalle: <?php echo $prod->getDetail()?></p>
                          <p class="card-text">Precio: <?php echo $prod->getPrice()?></p>
                          <p class="card-text">Estado: <?php echo $prod->getState()?></p>
                          <?php if(isset($_SESSION['idUser'])) {?>
                            <a href="<?php echo FRONT_ROOT?>Store/Buy/ <?php echo $prod->getIdProducto()?>" class="btn btn-primary btn-lg">Comprar</a>
                          <?php } ?>
                        </div>
                    </div>
                </div>
