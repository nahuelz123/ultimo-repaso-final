...
<body class="add-product-page">
    ...
    <main class="main">
        <div class="form-wrapper shadow-sm m-auto">
            ...
            <h1 class="title">Nuevo book</h1>

            <form action="<?php echo FRONT_ROOT?>Books/Add" method='post' class="form mt-4">
                ...
                <button class="btn btn-primary mb-4 m-auto" type="submit">agregar Book</button>
            </form>
        </div>
    </main>
