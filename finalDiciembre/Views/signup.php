...
<body class="signup-page">
    ...
    <main>
        <div class="form-wrapper shadow-sm">
            ...
            <form action="<?php echo FRONT_ROOT?>Session\signup" method = "post" class="form mt-4">
            <div class="form-group mb-4">
                    ...
                    <input type="text" name='lastName' id="lastName" class="form-control shadow-sm" required/>
                </div><div class="form-group mb-4">
            ...
            <div>
                <a href="<?php echo FRONT_ROOT?>Session\ShowLogin" class="text-primary">¿Ya tenes cuenta?</a>
            </div>
        </div>
    </main>
