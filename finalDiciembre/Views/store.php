                    ...
                    foreach ($storeList as $prod) { ?>
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                                ...
                                <?php if ( isset($_SESSION["idUser"]) && $_SESSION["idUser"] == $prod->getIdUser()) { ?>
                                    <a href="<?php echo FRONT_ROOT ?>Store/delete/ <?php echo $prod->getIdProducto() ?>" class="btn btn-primary">eliminar</a>
